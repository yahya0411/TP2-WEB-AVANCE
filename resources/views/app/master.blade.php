...
<head>
    ...
    <title>Tlemcen Testies - @yield('title')</title>
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-primary elevation-4 sidebar-dark-lightblue">
        ...
        <a href="index3.html" class="brand-link">
            ...
            <span class="brand-text font-weight-light">Tlemcen Testies</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block">{{$nom_artisan}}</a>
                </div>
            </div>
...
@if (session('status'))
<script>
    Command: toastr["success"]("{{Session::get('status')}}")
    toastr.options = {
  "closeButton": true,
  "debug": false,
  "newestOnTop": false,
